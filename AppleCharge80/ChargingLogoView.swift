...
private func drawFlow(
    ...
    let headX =
        ...
        bendB
    // ---------------------------------------------------------
    // Длина видимого ростка.
    //
    // В отличие от старой версии не рисуем весь путь
    // от низа до головы. Рисуется только короткий растущий
    // участок, поэтому он не выглядит как вертикальная линия.
    // ---------------------------------------------------------
    let stemLength =
        min(
